...
void smat_physics_alloc_init(SMAT_PHYSICS *mat, char codes[10]) {
    ...
    if (mat->code[0] == '1') {
        mat->SW_FLOW = true;
        mat->SW1_FLOW = true;
            mat->ivar_pos.h   = mat->ivar_pos.n; mat->ivar_pos.n++; // 1D SW
            mat->ivar_pos.uda = mat->ivar_pos.n; mat->ivar_pos.n++; // 1D SW
            mat->nSubmodels++;
        } else if (mat->code[0] == '2') {
            mat->SW_FLOW = true;
            mat->SW2_FLOW = true;
            mat->ivar_pos.h   = mat->ivar_pos.n; mat->ivar_pos.n++; // 2D SW
            mat->ivar_pos.uda = mat->ivar_pos.n; mat->ivar_pos.n++; // 2D SW
            mat->ivar_pos.vda = mat->ivar_pos.n; mat->ivar_pos.n++; // 2D SW
            mat->nSubmodels++;
        } else if (mat->code[0] == '3') {
            mat->SW_FLOW = true;
            mat->SW3_FLOW = true;
            mat->ivar_pos.dpl = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D SW 
            mat->ivar_pos.u   = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D SW
            mat->ivar_pos.v   = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D SW
            mat->nSubmodels++;
        } else if (mat->code[0] == '4') {
            mat->NS_FLOW = true;
            mat->NS3_FLOW = true;
            mat->ivar_pos.u   = mat->ivar_pos.n;   mat->ivar_pos.n++; // 3D NS 
            mat->ivar_pos.v   = mat->ivar_pos.n;   mat->ivar_pos.n++; // 3D NS
            mat->ivar_pos.w   = mat->ivar_pos.n;   mat->ivar_pos.n++; // 3D NS
            mat->ivar_pos.prs = mat->ivar_pos.n;   mat->ivar_pos.n++; // 3D NS
            mat->nSubmodels++;
        } else if (mat->code[0] == '5') {
            mat->NS_FLOW = true;
            mat->NS3_SPLIT = true;
            mat->ivar_pos.u = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D NS SPLIT
            mat->ivar_pos.v = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D NS SPLIT
            mat->ivar_pos.w = mat->ivar_pos.n; mat->ivar_pos.n++; // 3D NS SPLIT
            mat->nSubmodels++;
        } else if (mat->code[0] == '6') {
            mat->DW_FLOW = true;
            mat->ivar_pos.h = mat->ivar_pos.n; mat->ivar_pos.n++;   // 2D OF
            mat->nSubmodels++;
        } else if (mat->code[0] == '7') {
            mat->WVEL_SPLIT = true;
            mat->ivar_pos.w = mat->ivar_pos.n; mat->ivar_pos.n++;   // 3D SW - SPLIT
            mat->nSubmodels++;
        ...
        if (mat->code[1] == '1') {
            ...
            if (mat->ivar_pos.h == UNSET_INT) {
                mat->ivar_pos.h = mat->ivar_pos.n; mat->ivar_pos.n++; // 1D/2D/3D GROUNDWATER
            }
            mat->nSubmodels++;
        }
        ...
        for (itrns=0; itrns<mat->ivar_pos.ntrns; itrns++) {
            ...
            mat->ntrns++;
            mat->ivar_pos.con[itrns] = mat->ivar_pos.n; mat->ivar_pos.n++; // 1D/2D/3D TRANSPORT
            mat->nSubmodels++;
        }
