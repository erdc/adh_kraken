/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*! \file  sw2_bc_vel.c This file collections functions responsible for
...
int fe_sw2_bc_vel(SMODEL_SUPER *mod, double *elem_rhs, int ie, double perturbation, int perturb_node, int perturb_var, int perturb_sign, int DEBUG) {
     ...
     *==========================================================================================*/
    /*!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     *                                DIRICHLET VELOCITY Enforced weakly
     *--------------------------------------------------------------------------------------------
     * Calculates Dirichlet velocity contributions to the elemental residual. \n
     * \note
     *********************************************************************************************/
    //Mark TODO: Should pull velocity values and integrate that
    // get user velocities
    SVECT2D vel_def;
    int isers;
    ...
    //overwrie elem vel
    elem_vel[0].x = vel_def.x;
    elem_vel[0].y = vel_def.y;
    elem_vel[1].x = vel_def.x;
    elem_vel[1].y = vel_def.y;
