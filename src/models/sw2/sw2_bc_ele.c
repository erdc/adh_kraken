/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*! \file  sw2_bc_ele.c This file collections functions responsible for
...
int fe_sw2_bc_ele(SMODEL_SUPER *mod, double *elem_rhs, int ie, double perturbation, int perturb_node, int perturb_var, int perturb_sign, int DEBUG) {
    ...
    elem_node_z[0] = mod->grid->node[elem1d.nodes[0]].z;  //Need to ad back in + sw2->bed_displacement[elem1d.nodes[0]];
    elem_node_z[1] = mod->grid->node[elem1d.nodes[1]].z;  //Need to ad back in + sw2->bed_displacement[elem1d.nodes[1]];
    /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
     ...
     *********************************************************************************************/
        ...
        ele_data = sseries_get_value(isers, mod->series_head,0);
        elem_depth[0] = ele_data - elem_node_z[0];
        elem_depth[1] = ele_data - elem_node_z[0];
        if (elem_depth[0] < SMALL || elem_depth[1] < SMALL || elem_head[0] < SMALL || elem_head[1] < SMALL) return 0;
        //Mark NOTE: Same as tailwater but swapping in forcing data here like it should be
...
//need to get elem_density from dvar          
